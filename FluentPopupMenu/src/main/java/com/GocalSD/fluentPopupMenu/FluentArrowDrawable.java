...
public class FluentArrowDrawable extends ColorDrawable {
    ...
    public FluentArrowDrawable(int gravity, @ColorInt int foregroundColor, int strokeWidth, int strokeColor)
    {
